...
menu:
  leftnav:
    identifier: dbecca5201f3841320b1fda5e6c91ec5
    name: Final Project
    weight: 60
title: Final Project
type: course
uid: dbecca5201f3841320b1fda5e6c91ec5
...
For details on the default epidemic project, see [Controlling Epidemics on Networks]({{< baseurl >}}/sections/final-project/controlling-epidemics-on-networks).  It will give you an idea about the type of the research question and the deliverables.

For details on how to propose your own topic of interest together with some suggestions regarding the alternative topics, see [Proposing Your Own Application of Interest]({{< baseurl >}}/sections/final-project/proposing-your-own-application-of-interest).
